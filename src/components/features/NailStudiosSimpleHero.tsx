...
const topStores = [
  ...
  },
  {
    id: 3,
    name: "Nails & Beyond",
    image: "https://images.unsplash.com/photo-1619394082667-dc9cf16dff22?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    rating: 4.7,
    service: "Trendy Design",
    price: "₹700",
    location: "Select City Walk"
  }
];

const NailStudiosSimpleHero = () => {
...
export default NailStudiosSimpleHero;
